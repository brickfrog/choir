...
- After writing the test, run that same test command yourself and call `tdd_red_check` with its non-zero exit code. Red means the test failed for the behavior you are about to implement.
